...
### [싸이월드](https://github.com/CykoProject/CyProject)

- 개발 기간 : 2022.03.027 ~ 2022.06.01

기획부터 DB 설계, 백엔드와 프론트엔드 로직 개발 웹 개발의 수명주기를 총체적으로 체험해 본 프로젝트입니다. Spring Boot와 MariaDB, JavaScript, Thymeleaf를 사용했습니다.
## Education ✏
- 영남이공대학교 기계설계 졸업 (2013.03 ~ 2018.02)
